                        ...
                        <div class="row row-sm">
                            <div class="col-lg-6">
                                <div class="form-group has-success mg-b-0">
                                    ...
                                    <textarea class="form-control mg-t-20" placeholder="Textarea (success state)"
                                        required="" rows="3">This is textarea</textarea>
                                </div>
                            </div>
                            <div class="col-lg-6 mg-t-20 mg-lg-t-0">
                                <div class="form-group has-danger mg-b-0">
                                    <input class="form-control" placeholder="Input box (invalid state)" required=""
                                        type="text">
                                    <textarea class="form-control mg-t-20" placeholder="Textarea (invalid state)"
        ...
        <div class="col-md-12 col-xl-12 col-xs-12 col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="mg-t-40 mg-b-10">Show pallete only. If you'd like, spectrum can show the palettes you specify,
                        and nothing else.</p>
                    <div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row row-sm">
                        ...
                        <div class="col-lg-4 mg-b-20 mg-lg-b-0">
                            <p class="mg-b-10">Multiple Select with Pre-Filled Input</p><select class="form-control select2"
                                multiple="multiple">
                        ...
                        <div class="col-lg-4">
                            <p class="mg-b-10">Multiple Select (Disabled)</p><select class="form-control select2-no-search"
