...
@section('title', __('site.app_name') . ' | ' . __('site.edit employee'))
@section('css')
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('details.update', $employee->id) }}" method="post">
                        @csrf
                        @method('patch')
                        <div id="wizard3">
                                ...
                                <div class="row">
                                        ...
                                        <select class="form-control select2-no-search" name='company_id' id='section_list'>
                                            @isset($companies)
                                                ...
                                                @foreach ($companies as $job)
                                                    <option value="{{ $job->id }}"
                                                        {{ $job->id == $employee->company_id ? 'selected' : '' }}>
                                                        {{ $job->name }}</option>
                                                @endforeach
                                            @endisset
                                        </select>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control select2-no-search" name='category_id' id="product_id">
                                            <option value="{{ $employee->category_id }}">
                                                {{ $employee->categroy->name }}</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6">
